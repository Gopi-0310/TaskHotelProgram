...
namespace HotelBooking.Application.Services
{
    public class AuthServices : IAuthService
    {
            ...
            public AuthServices(UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager, IConfiguration config)
            {
        ...
        public async Task<IEnumerable<IdentityError>> Register(Registration register)
        {
            ...
            //ApplicationUser.PasswordHash = register.PasswordHash;
